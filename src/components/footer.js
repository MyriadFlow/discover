      ...
      <footer style={{ background: 'linear-gradient(90deg, #30D8FF 0%, #A32CC4 50%, #C243FE 100%)', padding: '40px 60px' }}>
        <section style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div className="links" style={{ textAlign: 'left', color: 'white', fontSize: '14px' }}>
            ...
            <Link href="/MyriadFlow_Terms_of_Service.pdf" target="_blank" style={{ color: 'white', textDecoration: 'none', display: 'block', marginTop: '28px' }}>
              Terms of Service
            </Link>
          ...
          <div className="platform" style={{ textAlign: 'left', color: 'white', fontSize: '14px' }}>
            ...
            <Link href="https://studio.myriadflow.com" style={{ color: 'white', textDecoration: 'none', display: 'block', marginTop: '28px'  }}>
              Studio
            </Link>
