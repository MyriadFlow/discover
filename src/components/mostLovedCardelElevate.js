...
const MostLovedCardElevate = ({ nft }) => {
  ...
  useEffect(() => {
    const brandmatch = async () => {
      ...
      try {
        const res = await fetch(`${baseUri}/brands/all/6c736e9b-37e6-43f5-9841-c0ac740282df`, {
          method: 'GET',
          headers: {
        ...
        const collres = await fetch(`${baseUri}/collections/all/6c736e9b-37e6-43f5-9841-c0ac740282df`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json'
          }
        ...
        const phyres = await fetch(`${baseUri}/phygitals/all/6c736e9b-37e6-43f5-9841-c0ac740282df`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json'
          }
...
export default MostLovedCardElevate;