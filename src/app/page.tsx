    ...
    <div className="bg-black">
      ...
      <div className="flex flex-col md:flex-row h-screen bg-white relative mt-20 md:mt-0">
        <div className="w-full md:w-1/2 h-full px-8 md:px-16 flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(to left, #F45EC1, #F45EC1, #F45EC1, #F45EC1, #F45EC1, #4EB9F3, #4EB9F3)",
            ...
            <div className="flex flex-col md:flex-row gap-6 mt-6 md:mt-28">
              ...
              <Link href="https://studio.myriadflow.com" target="_blank" style={exploreButtonStyle}>
                Launch
              </Link>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 h-full relative">
          ...
          />
          <div
            className="absolute bottom-4 left-8 text-white text-sm md:text-2xl md:mb-10 md:font-thin max-w-1/2 md:w-3/4 flex justify-center px-10 py-2 rounded-lg"
            style={{ backgroundColor: "rgba(228, 68, 230, 0.8)" }}
          >
            <p>
      ...
      {showForm && (
        ...
        >
          <div className="bg-white rounded-lg p-6 max-w-md w-full text-center">
            ...
            >
              Choose a public display name and user name, and share your email address to sign up
              with MyriadFlow.
            </h2>
