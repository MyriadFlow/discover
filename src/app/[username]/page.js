  ...
  useEffect(() => {
    const fetchPhygitals = async () => {
      try {
        ...
        const matchedfantoken = await Promise.all(
          phyresult.map(async (phygital) => {
            const amountBought = await mintedNFTs.reduce(async (countPromise, nft) => {
              const count = await countPromise;
              if (nft?.contract_type === "ERC1155") {
                try {
                  ...
                  const matchingFanToken = mintedFanTokens.find((token) => {
                    return (
                      token.nftContractAddress === phygital.contract_address &&
        ...
        const filteredMatchedFanToken = matchedfantoken.filter(
      ...
      <>
        ...
        <div className="flex flex-col p-6" style={{ marginLeft: "2.5rem" }}>
          <div className="flex mt-10">
            ...
            {owner ? (
              <h1 className="text-2xl mt-2" style={{ marginLeft: "2.5rem" }}>
                Creator
              </h1>
            ...
            {instagram || x ? (
              <>
                <img
                  src="/verified.png"
                  style={{ marginLeft: "2.5rem", height: "40px", width: "40px" }}
                />
              ...
              <>
                <img
                  ...
                  style={{ marginLeft: "2.5rem", height: "40px", width: "40px" }}
                />
                <button className="text-2xl mt-2 ml-2" onClick={handleVerify}>
                  Get Verified
                </button>
                ...
                {showForm && (
                  ...
                  >
                    <div className="flex flex-col bg-white rounded-lg p-8 max-w-md w-full text-center">
                      ...
                      >
                        To begin your verification process, you must link your X or Instagram
                        account.
                      </h2>
                      <button
                        onClick={() => {
          ...
          <div
            style={{ float: "right", width: "300px", marginLeft: "1150px", marginTop: "-200px" }}
          >
            ...
            >
              <div style={{ backgroundColor: "#FFFFFF" }}>
                ...
                <h1 style={{ fontSize: "1.125rem", color: "#6B7280" }} className="truncate-wallet">
                  {address}
                </h1>
              </div>
            </div>
          ...
          <div className="flex mt-10 text-gray-700">
            <button
              ...
              className={`text-lg hover:text-black hover:underline ${
                activeSection === "assets" ? "text-black underline" : ""
              }`}
            ...
            <button
              id="onsale"
              className={`text-lg hover:text-black hover:underline ${
                activeSection === "sale" ? "text-black underline" : ""
              }`}
              style={{ marginRight: "2.5rem", fontSize: "1.25rem" }}
            ...
            <button
              id="mybrands"
              className={`text-lg hover:text-black hover:underline ${
                activeSection === "brands" ? "text-black underline" : ""
              }`}
              style={{ marginRight: "2.5rem", fontSize: "1.25rem" }}
            ...
            <button
              id="mycollections"
              className={`text-lg hover:text-black hover:underline ${
                activeSection === "collections" ? "text-black underline" : ""
              }`}
              style={{ marginRight: "2.5rem", fontSize: "1.25rem" }}
            ...
            <button
              id="activity"
              className={`text-lg hover:text-black hover:underline ${
                activeSection === "activity" ? "text-black underline" : ""
              }`}
              style={{ marginRight: "2.5rem", fontSize: "1.25rem" }}
            ...
            <button
              id="rewards"
              className={`text-lg hover:text-black hover:underline ${
                activeSection === "rewards" ? "text-black underline" : ""
              }`}
              style={{ marginRight: "2.5rem", fontSize: "1.25rem" }}
            ...
            {owner ? (
              ...
              <button
                id="create"
                className={`text-lg hover:text-black hover:underline ${
                  activeSection === "create" ? "text-black underline" : ""
                }`}
                style={{ marginRight: "2.5rem", fontSize: "1.25rem" }}
          ...
          <div style={{ padding: "50px" }}>
            {activeSection === "assets" && (
              <>
                ...
                <div className="mt-10 flex" style={{ gap: "20px", flexWrap: "wrap" }}>
                  {Array.isArray(matchedWebxrs) &&
                    matchedWebxrs.map((nft, index) => <TokenNftCard key={index} nft={nft} />)}
                </div>
              </>
            )}
                    ...
                    <>
                      {!showCreatorOptions && status !== "pending" && status !== "done" && (
                        <>
                          <div className="flex gap-4">
                            ...
                            />
                            <h2 className="mt-2">
                              You have completed the verification process. Your profile is now
                              visible on <br /> the Users page. You can also now become a creator!
                            </h2>
                          </div>
                          <div className="flex gap-8 mt-10 mx-20">
                            <Link href="/users">
                              <button className="bg-pink-300 text-black rounded-full px-8 py-2 border border-black">
                                See Users
                              </button>
                            </Link>
                            <button
                        ...
                        <div style={{ marginTop: "20px" }}>
                          ...
                          <div style={{ marginTop: "10px" }}>
                            <Link href="https://studio.myriadflow.com/">
                              <button
                                className="text-black rounded-full px-8 py-2"
                                style={{
                                  marginLeft: "10px",
                                  backgroundColor: "rgba(48, 216, 255, 1)",
                                }}
                              >
                                Go to Studio
                              </button>
                      ...
                      {status === "pending" && (
                        <div>
                          <p className="mb-4 mt-8">
                            Thank you for your interest in the MyriadFlow Elevate Program! We look
                            forward to reviewing your application. Please keep checking your
                            provided email address, and this page for further communication. Best of
                            luck!
                          </p>
                        </div>
                      )}
                        ...
                        <>
                          <div className="flex gap-4">
                            ...
                            <h2 className="mt-2">
                              ...
                              <br />
                              We have credited your wallet with funds to claim your Basename (5+
                              characters for 1 year) and to launch your first collection.{" "}
                            </h2>
                          </div>
                          <div className="flex gap-8 mt-10 mx-20">
                            <a
                      ...
                      {hoveredOption === "premium" && (
                        <div className="popup" style={popupStyle}>
                          <h3>Premium Brand</h3>
                          <p>
                            Select this option if you meet the criteria to be featured as a premium
                            brand or creator on MyriadFlow&apos;s main Discover marketplace. Premium
                            brands enjoy enhanced visibility and access to exclusive tools designed
                            for established creators and brands.
                          </p>
                        </div>
                      )}
                      ...
                      {hoveredOption === "elevate" && (
                        <div className="popup" style={popupStyle}>
                          ...
                          <p>
                            Choose this option if you are an emerging creator or grassroots brand
                            seeking to leverage our platform&apos;s unique features.
                          </p>
                          <p>
                            You will benefit from sponsored Basenames and incur no upfront costs to
                            launch your phygital NFTs and virtual brand ambassadors.
                          </p>
                          <p>
                            As your brand develops and gains traction, you&apos;ll have the
                            opportunity to transition into the premium category and be showcased on
                            our main page.
                          </p>
                        </div>
                      )}
            ...
            {activeSection !== "assets" && activeSection !== "create" && (
              <div className="mt-10 text-center text-2xl text-gray-600">Coming Soon</div>
            )}
          </div>
        </div>
      ...
      <>
        ...
        <div
          style={{
            ...
            height: "350px",
            backgroundColor: coverImage ? "transparent" : "#D1D5DB",
            backgroundImage: guestCoverImage
              ? `url(https://gateway.pinata.cloud/ipfs/${guestCoverImage})`
              : "none",
            backgroundSize: "cover",
            backgroundPosition: "center",
            marginTop: "100px",
        ...
        >
          ...
          >
            <img
              src={
                guestprofileImage
                  ? `${process.env.NEXT_PUBLIC_GATEWAY_URL}/ipfs/${guestprofileImage}`
                  : "/profile.png"
              }
              alt="Profile"
              style={{
