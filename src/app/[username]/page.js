      ...
      if (address) {
        try {
          const response = await fetch(
            `${baseUri}/profiles/username/${username}`,
            {
              method: "GET",
              headers: {
  ...
  useEffect(() => {
    const fetchPhygitals = async () => {
      try {
            ...
            const amountBought = await mintedNFTs.reduce(
              async (countPromise, nft) => {
                ...
                if (nft?.contract_type === "ERC1155") {
                  try {
                    const response = await fetch(
                      `${baseUri}/get-mint-fantoken/${walletAddress}`,
                      {
                        method: "GET",
                        headers: {
                          "Content-Type": "application/json",
        ...
        const response = await fetch(
          `${baseUri}/webxr/all/554b4903-9a06-4031-98f4-48276c427f78`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
        ...
        const matchingWebxr = webxr.filter((web) =>
          filteredMatchedFanToken.some(
            (phygital) => phygital.id === web.phygital_id
          )
        );
  ...
  useEffect(() => {
    const getPhygitalData = async () => {
      if (walletAddress) {
        try {
          const response = await fetch(
            `${baseUri}/phygitals/deployer_address/${walletAddress}`,
            {
              method: "GET",
              headers: {
                "content-Type": "application/json",
  ...
  useEffect(() => {
    const getElevateData = async () => {
      if (walletAddress) {
        try {
          const response = await fetch(
            `${baseUri}/elevate/walletaddress/${walletAddress}`,
            {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
                ...
                {showForm && (
                  ...
                  >
                    <div className="flex flex-col bg-white rounded-lg p-8 max-w-md w-full text-center">
                      ...
                      >
                        To begin your verification process, you must link your X
                ...
                <div>
                  {instagram || x ? (
                    <>
                          ...
                          <>
                            <div className="flex gap-4">
                              ...
                              <h2 className="mt-2">
                                ...
                                Your profile is now visible on <br /> the Users
                                page. You can also now become a creator!
                              </h2>
                            </div>
                      ...
                      {showCreatorOptions &&
                        ...
                        status !== "done" && (
                          <div style={{ marginTop: "20px" }}>
                            <h2>
                              You have not yet created any brands. Go to studio
                              to get started.
                            </h2>
                      ...
                      {status === "pending" && (
                        <div>
                          <p className="mb-4 mt-8">
                            Thank you for your interest in the MyriadFlow
                            Elevate Program! We look forward to reviewing your
                            application. Please keep checking your provided
                            email address, and this page for further
                        ...
                        <>
                          <div className="flex gap-4">
                            ...
                            <h2 className="mt-2">
                              ...
                              our Elevate Program!
                              <br />
                              We have credited your wallet with funds to claim
                              your Basename (5+ characters for 1 year) and to
                      ...
                      {hoveredOption === "premium" && (
                        <div className="popup" style={popupStyle}>
                          <h3>Premium Brand</h3>
                          <p>
                            Select this option if you meet the criteria to be
                            featured as a premium brand or creator on
                            MyriadFlow&apos;s main Discover marketplace. Premium
                            brands enjoy enhanced visibility and access to
                            exclusive tools designed for established creators
                            and brands.
                          </p>
                        </div>
                      )}
                      ...
                      {hoveredOption === "elevate" && (
                        <div className="popup" style={popupStyle}>
                          ...
                          <p>
                            ...
                            grassroots brand seeking to leverage our
                            platform&apos;s unique features.
                          </p>
                          <p>
                            You will benefit from sponsored Basenames and incur
                            no upfront costs to launch your phygital NFTs and
                            virtual brand ambassadors.
                          </p>
                          <p>
                            As your brand develops and gains traction,
                            you&apos;ll have the opportunity to transition into
                            the premium category and be showcased on our main
                            page.
                          </p>
                        </div>
                      )}
                    ...
                    <div>
                      ...
                      <p>
                        Please link your Instagram or X account to create
                        content.
                      </p>
                    </div>
                  )}
