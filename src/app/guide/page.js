    ...
    return (
        <>
            ...
            <div className="max-w-4xl mx-auto px-4 py-8 mt-32">
                <h1 className="text-4xl font-bold mb-4">Create a profile</h1>
                ...
                <h2 className="text-2xl font-semibold mb-4">How to create a profile:</h2>

                <p className="mb-4">To get started on MyriadFlow, you&apos;ll need:</p>
                ...
                <h3 className="text-xl font-semibold mb-2">Steps to Create Your Profile:</h3>
                ...
                <ol className="list-decimal pl-6 mb-6 space-y-2">
                    ...
                    <li>Visit https://discover.myriadflow.com/users to see your profile among other users!
                ...
                <p className="mb-8">
                    We&apos;d love to have you with us! Join our active communities on Telegram and Discord to stay updated, engage in discussions, and interact with our team and other early adopters.
                </p>
